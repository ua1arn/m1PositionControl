...
#define PID_TORQUE_KP_DEFAULT         3020
#define PID_TORQUE_KI_DEFAULT         256
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3020
...
#define PID_SPEED_KP_DEFAULT          2061/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          2954/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V          43 /*!< Over-voltage
                                                         threshold */
...
#define FINAL_I_ALIGNMENT               16021 /*!< s16A */
